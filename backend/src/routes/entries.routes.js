...
router.put('/client/:clientEntryId', auth, entriesController.upsertEntryByClientId);
router.delete('/client/:clientEntryId', auth, entriesController.deleteEntryByClientId);
