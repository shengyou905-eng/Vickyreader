...
router.get('/privacy', (_req, res) => {
  ...
  <section><h2>三、小U与第三方 AI</h2>
    ...
    <ul>
      ...
      <li>小U全局对话和“小U问我”可能使用近期划线、阅读想法、小U解读、用户明确授权的随心记和明台公开痕迹。</li>
    </ul>
...
router.get('/ai', (_req, res) => {
  ...
  <section><h2>四、用户控制</h2><ul><li>首次使用前选择“同意并继续”或“暂不同意”。</li><li>在设置中随时撤回授权。</li><li>删除单条小U解读、阅读提问或完整对话记录。</li><li>随心记只有在用户对单条记录主动授权后，才可能进入小U上下文；授权可撤回。</li><li>不要提交身份证、密码、医疗健康、金融账户、精确位置等敏感信息。</li></ul></section>
